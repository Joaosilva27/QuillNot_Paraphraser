          ...
          <div className='flex flex-wrap gap-2 sm:gap-3 items-center mb-2'>
            ...
            {isAiBypasserEnabled && !isAiBypasserDisclamerClosed && (
              <div className='flex-1 text-xs font-semibold ml-2'>
                AI Bypasser Mode attempts to make your text less detectable as AI-generated by rephrasing common machine-used patterns and vocabulary.
                However, it does not guarantee full evasion of AI detectors, no tool can reliably do this yet. Claims of 100% bypass are marketing
                hype, not technical reality.
                <span onClick={() => setIsAiBypasserDisclaimerClosed(true)} className='text-black font-semibold underline ml-2 cursor-pointer'>
                  [HIDE TEXT]
                </span>
              </div>
            )}
